...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button ListaServicos = findViewById(R.id.ListaServicos);
        ListaServicos.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button ListaClientes = findViewById(R.id.ListaClientes);
